...
#ifndef SOUND_SWIFT_H
#define SOUND_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="sound",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC5sound11AppDelegate")
...
SWIFT_CLASS("_TtC5sound13SceneDelegate")
...
SWIFT_CLASS("_TtC5sound14ViewController")
@interface ViewController : UIViewController
@property (nonatomic, strong) IBOutlet UIButton * _Null_unspecified drumButton;
@property (nonatomic, strong) IBOutlet UIButton * _Null_unspecified pianoButton;
@property (nonatomic, strong) IBOutlet UIButton * _Null_unspecified guitarButton;
- (void)viewDidLoad;
- (IBAction)tapDownDrumButton;
- (IBAction)touchUpDrumButton;
- (IBAction)touchDownPianoButton;
- (IBAction)touchUpPianoButton;
- (IBAction)touchDownGuitarButton;
- (IBAction)touchUpGuitarButton;
